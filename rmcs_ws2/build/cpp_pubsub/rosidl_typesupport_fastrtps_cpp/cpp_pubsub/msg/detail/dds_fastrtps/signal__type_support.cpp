...
#include "cpp_pubsub/msg/detail/signal__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const cpp_pubsub::msg::Signal & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  cpp_pubsub::msg::Signal & ros_message)
{
  // Member: sine_wave
  cdr >> ros_message.sine_wave;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = cpp_pubsub::msg::Signal;
    is_plain =
      (
...
size_t
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_cpp_pubsub
max_serialized_size_key_Signal(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
...
{
  auto typed_message =
    static_cast<const cpp_pubsub::msg::Signal *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<cpp_pubsub::msg::Signal *>(
    untyped_ros_message);
...
{
  return &cpp_pubsub::msg::typesupport_fastrtps_cpp::_Signal__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, cpp_pubsub, msg, Signal)() {
  return &cpp_pubsub::msg::typesupport_fastrtps_cpp::_Signal__handle;
}
